...
class TestEMLAssertions(unittest.TestCase):
    ...
    def test_101(self):
        ...
        self.assertEqual(doc.documentElement.tagName, 'emotionml', printOutcome("101", "fail",
                                                                                "The root element of standalone EmotionML documents is not <emotionml>."))
    ...
    def test_102(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertEqual(doc.documentElement.getAttribute('xmlns'), "http://www.w3.org/2009/10/emotionml",
                         printOutcome('102', 'fail',
                                      'The <emotionml> element does not define the EmotionML namespace: "http://www.w3.org/2009/10/emotionml".'))
        print printOutcome("102", "pass",
                           'The <emotionml> element defines the EmotionML namespace: "http://www.w3.org/2009/10/emotionml".')
    ...
    def test_103(self):
        ...
        self.assertTrue(len(doc.getElementsByTagName("emotion")) > 0,
                        printOutcome('103', 'fail',
                                     'The <emotionml> element cannot contain one or more <emotion> elements.'))
    ...
    def test_104(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertEqual(len(doc.getElementsByTagName("vocabulary")), 2, printOutcome('104', 'fail',
                                                                                      'The <emotionml> element cannot contain one or more <vocabulary> elements.'))
    ...
    def test_105(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.getElementsByTagName("info"),
                        printOutcome('105', 'fail', 'The <emotionml> element cannot contain a single <info> element.'))
    ...
    def test_110(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.documentElement.getAttribute('version'), printOutcome('110', 'fail',
                                                                                  'The root element of a standalone EmotionML document does not have an attribute "version".'))
        print printOutcome("110", "pass",
                           'The root element of a standalone EmotionML document has an attribute "version".')
    ...
    def test_111(self):
        try:
            ...
            return
        self.fail(printOutcome('111', 'fail', 'The "version" attribute of <emotionml> does not have the value "1.0"'))
    ...
    def test_112(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.documentElement.getAttribute('category-set'),
                        printOutcome("112", 'fail',
                                     'The <emotionml> element cannot contain an attribute "category-set".'))
    ...
    def test_113(self):
        ...
        try:
            ...
            print printOutcome("113", 'pass',
                               'The "category-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI')
            return
        self.fail(printOutcome("113", 'fail',
                               'The "category-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI'))
    ...
    def test_115(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.documentElement.getAttribute('dimension-set'), printOutcome('115', 'fail',
                                                                                        'The <emotionml> element cannot contain an attribute "dimension-set".'))
    ...
    def test_116(self):
        ...
        try:
            ...
            print printOutcome("116", 'pass',
                               'The "dimension-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI')
            return
        self.fail(printOutcome("116", 'fail',
                               'The "dimension-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI'))
    ...
    def test_118(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.documentElement.getAttribute('appraisal-set'), printOutcome("118", 'fail',
                                                                                        'The <emotionml> element cannot contain an attribute "appraisal-set".'))
    ...
    def test_121(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.documentElement.getAttribute('action-tendency-set'),
                        printOutcome('121', 'fail',
                                     'The <emotionml> element cannot contain an attribute "action-tendency-set".'))
    ...
    def test_122(self):
        ...
        try:
            ...
            print e
            self.fail(printOutcome("122", 'fail',
                                   'The "action-tendency-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI'))
        try:
            eml.action_tendency_set = "#link#"
            emxml = eml.to_xml().toprettyxml()
    ...
    def test_150(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertEqual(len(doc.getElementsByTagName('category')), 2, printOutcome('150', 'fail',
                                                                                    'The <emotion> element cannot contain one or more <category> elements.'))
    ...
    def test_151(self):
        ...
        self.assertEqual(len(doc.getElementsByTagName('dimension')), 2, printOutcome('151', 'fail',
                                                                                     'The <emotion> element cannot contain one or more <dimension> elements.'))
    ...
    def test_152(self):
        ...
        self.assertEqual(len(doc.getElementsByTagName('appraisal')), 2, printOutcome('152', 'fail',
                                                                                     'The <emotion> element cannot contain one or more <appraisal> elements.'))
    ...
    def test_153(self):
        ...
        self.assertEqual(len(doc.getElementsByTagName('action-tendency')), 2, printOutcome('153', 'fail',
                                                                                           'The <emotion> element cannot contain one or more <action-tendency> elements.'))
    ...
    def test_154(self):
        ...
        rep = Representation('pride', 'category')
        emo.categories.append(rep)
        ref = Reference(uri="http://www.example.com/data/video/v1/avi?t=2,13", role='expressedBy',
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertEqual(len(doc.getElementsByTagName('reference')), 2, printOutcome('154', 'fail',
                                                                                     'The <emotion> element cannot contain one or more <reference> elements.'))
    ...
    def test_155(self):
        ...
        doc = parseString(emxml)
        self.assertTrue(doc.getElementsByTagName('info'),
                        printOutcome('155', 'fail', 'The <emotion> element MAY contain a single <info> element.'))
    ...
    def test_156(self):
        try:
            ...
            print printOutcome('156', 'pass',
                               'The <emotion> element requires at least one <category> or <dimension> or <appraisal> or <action-tendency> element.')
            return
        self.fail(printOutcome('156', 'fail',
                               'The <emotion> element does not require at least one <category> or <dimension> or <appraisal> or <action-tendency> element.'))
    ...
    def test_159(self):
        ...
        self.assertTrue(emotions[0].getAttribute('category-set'), printOutcome("159", 'fail',
                                                                               'The <emotionml> element cannot contain an attribute "category-set".'))
    ...
    def test_160(self):
        ...
        emo = Emotion()
        rep = Representation('pride', 'category') # sets the set
        emo.categories.append(rep)

        emo.dimension_set = "#link"
        emxml = emo.to_xml(Document()).toprettyxml()

        try:
            emo.dimension_set = "link%Z"
            emxml = emo.to_xml(Document()).toprettyxml()
        except ValueError:
            print printOutcome("160", 'pass',
                               'The "category-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI')
            return
        self.fail(printOutcome("160", 'fail',
                               'The "category-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI'))
    ...
    def test_162(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('dimension-set'), printOutcome('162', 'fail',
                                                                                'The <emotionml> element cannot contain an attribute "dimension-set".'))
    ...
    def test_165(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('appraisal-set'), printOutcome("165", 'fail',
                                                                                'The <emotionml> element cannot contain an attribute "appraisal-set".'))
    ...
    def test_166(self):
        ...
        emo = Emotion()
        rep = Representation('pride', 'appraisal') # sets the set
        emo.appraisals.append(rep)

        emo.appraisal_set_set = "#link"
        emxml = emo.to_xml(Document()).toprettyxml()

        try:
            emo.appraisal_set = "link%Z"
            emxml = emo.to_xml(Document()).toprettyxml()
        except ValueError:
            print printOutcome("166", 'pass',
                               'The "appraisal-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI')
            return
        self.fail(printOutcome("166", 'fail',
                               'The "appraisal-set" attribute of <emotionml>, if present, MUST be of type xsd:anyURI'))
    ...
    def test_168(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('action-tendency-set'), printOutcome('168', 'fail',
                                                                                      'The <emotionml> element cannot contain an attribute "action-tendency-set".'))
    ...
    def test_169(self):
        ...
        try:
            ...
            return
        self.fail(printOutcome("169", 'fail',
                               '"action-tendency-set" attribute of <emotion>, if present, MUST be of type xsd:anyURI.'))
    ...
    def test_171(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('version'),
                        printOutcome('171', 'fail', '	The <emotion> element cannot have an attribute "version".'))
    ...
    def test_172(self):
        try:
            ...
            return
        self.fail(printOutcome('172', 'fail', "The 'version' attribute of <emotion> doesn't have the value '1.0'."))
    ...
    def test_173(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('id'),
                        printOutcome('173', 'fail', "The <emotion> element can't contain an attribute 'id'."))
    ...
    def test_174(self):
        ...
        try:
            ...
            self.fail(
                printOutcome("174", 'fail', 'The "id" attribute of <emotion>, if present, MUST be of type xsd:ID.'))
    ...
    def test_175(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('start'),
                        printOutcome('175', 'fail', "The <emotion> element cannot have an attribute 'start'."))
    ...
    def test_176(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('end'),
                        printOutcome('176', 'fail', "The <emotion> element does not have an attribute 'end'."))
    ...
    def test_177(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('duration'),
                        printOutcome('177', 'fail', 'The <emotion> element does not have an attribute "duration".'))
    ...
    def test_178(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('time-ref-uri'),
                        printOutcome('178', 'fail', 'The <emotion> element does not have an attribute "time-ref-uri".'))
    ...
    def test_179(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('time-ref-anchor-point'), printOutcome('179', 'fail',
                                                                                        'The <emotion> element does not have an attribute "time-ref-anchor-point".'))
    ...
    def test_180(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('offset-to-start'), printOutcome('180', 'fail',
                                                                                  'The <emotion> element does not have an attribute "offset-to-start".'))
    ...
    def test_181(self):
        ...
        doc = parseString(emxml)
        emotions = doc.getElementsByTagName('emotion')
        self.assertTrue(emotions[0].getAttribute('expressed-through'),
                        printOutcome('181', 'fail', 'The <emotion> element MAY have an attribute "expressed-through".'))
    ...
    def test_211(self):
        ...
        self.assertTrue(categories[0].getAttribute('name'),
                        printOutcome("211", 'fail', 'A <category> element does not contain a "name" attribute.'))
        print printOutcome("211", 'pass', 'A <category> element contains a \"name\" attribute.')

    def test_212(self):
    #TODO: This cannot be fully checked
        print printOutcome('212', 'not-impl',
    ...
    def test_214(self):
        ...
        doc = parseString(emxml)
        categories = doc.getElementsByTagName('category')
        self.assertTrue(categories[0].getAttribute('value'),
                        printOutcome("214", 'fail', 'A <category> can not contain a "value" attribute.'))
    ...
    def test_215(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertTrue(doc.getElementsByTagName('trace'),
                        printOutcome("215", 'fail', 'A <category> can not contain a <trace> element.'))
    ...
    def test_217(self):
        ...
        doc = parseString(emxml)
        categories = doc.getElementsByTagName('category')
        self.assertTrue(categories[0].hasAttribute('confidence'),
                        printOutcome("217", 'fail', 'A <category> element cannot contain a "confidence" attribute.'))
    ...
    def test_221(self):
        ...
        self.assertTrue(dimensions[0].getAttribute('name'),
                        printOutcome("221", 'fail', 'A dimension element does not contain a "name" attribute.'))
    ...
    def test_225(self):
        ...
        doc = parseString(emxml)
        dimensions = doc.getElementsByTagName('dimension')
        self.assertTrue(dimensions[0].hasAttribute('confidence'),
                        printOutcome("225", 'fail', 'A <dimension> element cannot contain a "confidence" attribute.'))
    ...
    def test_231(self):
        ...
        self.assertTrue(appraisals[0].getAttribute('name'),
                        printOutcome("231", 'fail', 'An appraisal element does not contain a "name" attribute.'))
    ...
    def test_234(self):
        ...
        doc = parseString(emxml)
        appraisals = doc.getElementsByTagName('appraisal')
        self.assertTrue(appraisals[0].getAttribute('value'),
                        printOutcome("234", 'fail', 'A <appraisal> can not contain a "value" attribute.'))
    ...
    def test_235(self):
        ...
        doc = parseString(emxml)
        self.assertTrue(doc.getElementsByTagName('trace'),
                        printOutcome("235", 'fail', 'A <appraisal> can not contain a <trace> element.'))
    ...
    def test_236(self):
        try:
            ...
            print printOutcome("236", 'pass',
                               'A <appraisal> cannot contain both a "value" attribute and a <trace> element.')
            return
        self.fail(
            printOutcome("236", 'fail', 'A <appraisal> can contain both a "value" attribute and a <trace> element.'))
    ...
    def test_237(self):
        ...
        doc = parseString(emxml)
        appraisals = doc.getElementsByTagName('appraisal')
        self.assertTrue(appraisals[0].hasAttribute('confidence'),
                        printOutcome("237", 'fail', 'A <appraisal> element cannot contain a "confidence" attribute.'))
    ...
    def test_241(self):
        ...
        self.assertTrue(action_tendencies[0].getAttribute('name'),
                        printOutcome("241", 'fail', 'An action-tendency element does not contain a "name" attribute.'))
    ...
    def test_243(self):
        try:
            ...
            return
        self.fail(
            printOutcome("243", 'fail', "An action tendency with name 'x' may appear twice in one <emotion> element."))
    ...
    def test_244(self):
        ...
        self.assertTrue(AT[0].getAttribute('value'),
                        printOutcome("244", 'fail', 'A <action-tendency> can not contain a "value" attribute.'))
    ...
    def test_245(self):
        ...
        doc = parseString(emxml)
        self.assertTrue(doc.getElementsByTagName('trace'),
                        printOutcome("245", 'fail', 'A <action-tendency> can not contain a <trace> element.'))
    ...
    def test_246(self):
        try:
            ...
            print printOutcome("246", 'pass',
                               'A <action-tendency> cannot contain both a "value" attribute and a <trace> element.')
            return
        self.fail(printOutcome("246", 'fail',
                               'A <action-tendency> can contain both a "value" attribute and a <trace> element.'))
    ...
    def test_247(self):
        ...
        doc = parseString(emxml)
        AT = doc.getElementsByTagName('action-tendency')
        self.assertTrue(AT[0].hasAttribute('confidence'), printOutcome("247", 'fail',
                                                                       'A <action-tendency> element cannot contain a "confidence" attribute.'))
    ...
    def test_300(self):
        try:
            ...
            print printOutcome("300", "pass",
                               "The value of the 'confidence' attribute must be in the closed interval [0, 1].")
            return
        self.fail(printOutcome("300", "fail",
    ...
    def test_305(self):
        ...
        self.assertTrue(node[0].getAttribute('id'),
                        printOutcome('305', 'fail', 'The <info> element MAY contain an attribute "id".'))
    ...
    def test_306(self):
        ...
        try:
            ...
            self.fail(printOutcome("306", 'fail',
                                   'The "id" attribute of the <info> element, if present, MUST be of type xsd:ID.'))
        valid_ids = ['_7', 'az56', 'A-hjk0', '_---']
        last = ""
        try:
    ...
    def test_413(self):
        ...
        self.assertTrue(refs[0].hasAttribute('role'),
                        printOutcome("413", 'fail', 'The <reference> element MAY contain a "role" attribute.'))
    ...
    def test_414(self):
        try:
            ...
            print printOutcome("414", 'pass',
                               'The value of the "role" attribute of the <reference> element, if present, MUST be one of "expressedBy", "experiencedBy", "triggeredBy", "targetedAt".')
            return
        self.fail(printOutcome("414", 'fail',
                               'The value of the "role" attribute of the <reference> element, if present, MUST be one of "expressedBy", "experiencedBy", "triggeredBy", "targetedAt".'))

    def test_415(self):
        eml = EmotionML()
        emo = Emotion()
        ref = Reference("http://some-uri", 'triggeredBy', 'video/ogg')
        emo.references.append(ref)
        rep = Representation('power', 'action-tendency')
        emo.action_tendencies.append(rep)
        eml.action_tendency_set = "http://www.w3.org/TR/emotion-voc/xml#frijda-action-tendencies"
        ...
        doc = parseString(emxml)
        refs = doc.getElementsByTagName('reference')
        self.assertTrue(refs[0].hasAttribute('media-type'),
                        printOutcome("415", 'fail', 'The <reference> element cannot contain a "media-type" attribute.'))
    ...
    def test_424(self):
        ...
        try:
            ...
            print printOutcome('424', 'pass',
                               'The value of the "time-ref-anchor-point" attribute of <emotion> is either "start" or "end".')
            return
        self.fail(printOutcome('424', 'fail',
                               'The value of the "time-ref-anchor-point" attribute of <emotion> is not either "start" or "end".'))
    ...
    def test_425(self):
        ...
        for inv in invalid_val:
            try:
                ...
                self.fail(printOutcome("425", "fail",
                                       'The value of the "offset-to-start" attribute of <emotion>, if present, MUST be of type xsd:integer'))
        try:
            eml = EmotionML()
            emo = Emotion()
    ...
    def test_500(self):
        try:
            ...
            print printOutcome("500", "pass",
                               'The value of a "value" attribute, if present, MUST be a floating point value from the closed interval [0, 1].')
            return
        self.fail(printOutcome("500", "fail",
                               "The value of a 'value' attribute, if present, MUST be a floating point value from the closed interval [0, 1]."))
    ...
    def test_502(self):
        ...
        try:
            ...
            self.fail(printOutcome("502", 'fail',
                                   'The value of the "freq" attribute of <trace> MUST be a positive floating point number followed by optional whitespace followed by "Hz".'))
    ...
    def test_504(self):
        ...
        try:
            ...
            self.fail(printOutcome("504", 'fail',
                                   'The value of the "samples" attribute of <trace> MUST be a space-separated list of floating point values from the closed interval [0, 1].'))
    ...
    def test_601(self):
        ...
        emxml = eml.to_xml().toprettyxml()
        doc = parseString(emxml)
        self.assertEqual(len(doc.getElementsByTagName('info')), 1,
                         printOutcome("601", 'fail', 'A <vocabulary> element MAY contain a single <info> element.'))
    ...
    def test_603(self):
        try:
            ...
            voc = Vocabulary('NotAType', 'big6', items)
            eml.vocabularies.append(voc)
            emxml = eml.to_xml().toprettyxml()
            doc = parseString(emxml)
        except:
            print printOutcome('603', 'pass',
                               'The value of the "type" attribute of the <vocabulary> element MUST be one of "category", "dimension", "action-tendency" or "appraisal".')
            return
        self.fail(printOutcome('603', 'fail',
                               'The value of the "type" attribute of the <vocabulary> element isn\'t required to be one of "category", "dimension", "action-tendency" or "appraisal".'))
    ...
    def test_605(self):
        ...
        try:
            ...
            self.fail(printOutcome("605", 'fail',
                                   'The value of the "id" attribute of the <vocabulary> element MUST be of type xsd:ID.'))
    ...
    def test_606(self):
        ...
        doc = parseString(emxml)
        self.assertEqual(len(doc.getElementsByTagName('info')), 1,
                         printOutcome("606", 'fail', 'An <item> element MAY contain a single <info> element.'))
    ...
    def test_608(self):
        ...
        print printOutcome('608', 'pass',
                           ...
                           comment="Vocabulary checks were not implemented in this release. See ")
    ...
    def test_700(self):
        ...
        self.assertEqual(ns, "http://www.w3.org/2009/10/emotionml", printOutcome('700', 'fail',
                                                                                 'All EmotionML elements MUST use the EmotionML namespace, "http://www.w3.org/2009/10/emotionml". '))
        print printOutcome('700', 'pass',
                           'All EmotionML elements MUST use the EmotionML namespace, "http://www.w3.org/2009/10/emotionml". ')
